...
//
// For all Func variants, less must report whether a should sort before b. It must define a
// strict weak ordering and must not mutate its arguments or the slice being sorted. Passing
// a nil comparator panics. Results are unspecified if less is inconsistent or has side effects.
package sorting
